...
@section('content')
    <form action="{{ route('reminder.store') }}" method="POST" role="form" class="form-auth">
        ...
        <p class="text-muted">
            Provide the smae emial address that you've registered and check your email inbox to reset the password.
        </p>
        ...
        <button class="btn btn-primary btn-block" type="submit">Send Reminer </button>
